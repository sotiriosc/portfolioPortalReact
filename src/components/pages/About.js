  ...
  return (
    <div className='home'>
      ...
      <div className='aboutPar'>
        ...
        <p> My fascination with life extends into every domain. From tangible physical pursuits to the limitless landscapes of imagination, I embrace the plethora of enriching opportunities life offers. My openness to these experiences fuels my hunger for knowledge, while my analytical mindset makes computational concepts intuitive, enabling me to solve problems and deliver solutions with efficiency and precision.</p>
        <p>Coding offers a unique and fulfilling experience—it's a fascinating intersection of creativity and logic that serves as a platform to contribute meaningfully to the rapidly evolving technological landscape. This confluence stirred my interest in software development, a journey I'm thrilled to embark upon. Beyond the intellectual challenge of understanding new concepts and ideas, coding also allows me to serve the interests of the community around me.</p>
